...
if (!window.site) window.site = {}; // One time after page loading

window.site.initPage = function () {}; // Every time after creating new elements. For example: after ajax loading
